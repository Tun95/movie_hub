...
const TopRatedMovies: React.FC = () => {
  ...
  return (
    <section className="py-16 px-8 max-w-7xl mx-auto bg-gradient-to-r from-brand-dark to-brand-dark/80">
      <div className="mb-8">
        <span className="text-brand-orange text-sm font-bold uppercase tracking-wider">
          Critics Choice
        </span>
        <h2 className="text-3xl font-bold mt-2">Top Rated Movies</h2>
      </div>
